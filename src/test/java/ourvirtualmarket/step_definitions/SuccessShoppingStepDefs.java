...
public class SuccessShoppingStepDefs {
    ...
    @Then("The user verifies that {string} button at the right-bottom of the page")
    public void the_user_verifies_that_button_at_the_right_bottom_of_the_page(String string) {
    ...
    public void the_user_is_navigated_to_the_menu(String string) {
    }
    @When("The user fills in all the necessary menus and clicks on the {string} button")
    public void the_user_fills_in_all_the_necessary_menus_and_clicks_on_the_button(String string) {
    }
    ...
    @When("The user selects the delivery address and clicks on the {string} button")
    public void the_user_selects_the_delivery_address_and_clicks_on_the_button(String string) {
    }
    ...
    @When("The user accepts {string} and clicks on the {string} button")
    public void the_user_accepts_and_clicks_on_the_button(String string, String string2) {
    }
    ...
    public void the_user_verifies_the_following_messages(io.cucumber.datatable.DataTable dataTable) {
    }
