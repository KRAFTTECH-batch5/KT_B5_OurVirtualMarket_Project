...
public class LoginStepDefs {
    ...
    @When("The user provides invalid credentials that {string} and {string}")
    public void the_user_provides_invalid_credentials_that_and(String email, String password) {
    ...
    @Then("The user should see the New Customer table")
    public void the_user_should_see_the_new_customer_table() {
        loginPage.verifyNewCustomerTable();
    }

    @Then("The user should see the Returning Customer table")
    public void the_user_should_see_the_returning_customer_table() {
        loginPage.verifyReturningCustomerTable();
    }
}
